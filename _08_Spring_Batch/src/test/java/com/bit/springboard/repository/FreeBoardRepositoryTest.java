...
public class FreeBoardRepositoryTest {
    ...
    void findByIdTest() throws Exception {
        ...
        FreeBoard freeBoard = FreeBoard.builder()
                ...
                .content("asdasd")
                .cnt(1)
                .regdate(LocalDateTime.parse("2024-08-28T11:41:02.292449"))
                .moddate(LocalDateTime.parse("2024-08-28T11:41:02.292483"))
        ...
        Assertions.assertEquals("asd123123123", findByIdFreeBoard.getTitle());
